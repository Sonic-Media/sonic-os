...
interface StockProductDetailQuickActionsProps {
  onEdit: () => void;
  onStockIn: () => void;
  onStockOut: () => void;
  onDelete: () => void;
...
export function StockProductDetailQuickActions({
  onEdit,
  onStockIn,
  onStockOut,
  onDelete,
}: StockProductDetailQuickActionsProps) {
  return (
    <section>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <ActionButton label="Edit Item" icon={<EditIcon />} onClick={onEdit} />
        <ActionButton label="Stock In" icon={<StockInIcon />} onClick={onStockIn} />
        <ActionButton label="Stock Out" icon={<StockOutIcon />} onClick={onStockOut} />
        <ActionButton
          label="Delete Item"
          icon={<DeleteIcon />}
          onClick={onDelete}
